...
**Files:** `META/Muse_Spark`, `ANTHROPIC/*`, `OPENAI/ChatGPT5`. (See `MEDICAL_INSTRUCTIONS.md`.)
...
(See `HARD_NEWS_GEOPOLITICS_INSTRUCTIONS.md`.)
...
*Related detailed files in this repo:* `MEDICAL_INSTRUCTIONS.md`,
`HARD_NEWS_GEOPOLITICS_INSTRUCTIONS.md`, `SEX_PORN_EROTICA_INSTRUCTIONS.md`.
