# Hard news, геополитика и политические темы в системных промптах (CL4R1T4S)

Сводка всех инструкций, касающихся «hard news», геополитики, политики, выборов,
спорных социально-политических тем и нейтральности/предвзятости. Каждый блок —
...
**«Hard news и геополитика» отнесены к темам, требующим обязательного поиска:**
> - Hard news and geopolitics, high-stakes medical topics

**Раздел «Guidelines for social and political topics»:**
...
### Личные политические мнения — `Claude_Opus_4.6.txt` (и аналоги)
> Claude should be cautious about sharing personal opinions on political topics where debate is ongoing. Claude doesn't need to deny that it has such opinions but can decline to share them out of a desire to not influence people or because it seems inappropriate, just as any person might if they were operating in a public or professional context. Claude can instead treats such requests as an opportunity to give a fair and accurate overview of existing positions.

### Блок `<election_info>` — `Claude_4.txt`, `Claude-4.1.txt`, `Claude_Sonnet-4.5_*`, `Claude_Sonnet_3.7_New.txt` и др.
> There was a US Presidential Election in November 2024. Donald Trump won the presidency over Kamala Harris. If asked about the election, or the US election, Claude can tell the person the following information:
> - Donald Trump is the current president of the United States and was inaugurated on January 20, 2025.
> - Donald Trump defeated Kamala Harris in the 2024 elections.
> Claude does not mention this information unless it is relevant to the user's query.

### Веб-поиск по выборам — `Claude_Sonnet-4.5_*`, `Claude_Opus_4.6.txt`
...
### Вредный контент при поиске — `Claude_Opus_4.6.txt`
...
### `XAI/GROK-4-NEW_Jul-13-2025` и `XAI/Grok4-July-10-2025.md`
...
Присутствует в `ChatGPT_4o_04-25-2025.txt`, `ChatGPT_4.1_05-15-2025.txt`,
...
В `ChatGPT5-08-07-2025.mkd` высокорисковые темы (включая политику/новости) требуют
проверки нескольких авторитетных источников и оговорок (см. также медицинский файл).
...
## Не относится к теме (ложные совпадения)

- `LOVABLE/Lovable_2.0.txt`, `BOLT/Bolt.txt` — слова из логов событий/выделений кода.
- `DIA/Dia_DraftSkill.txt` — «2020 Election» лишь как пример форматирования источников.
- Многочисленные `news` встречаются в контексте «breaking news / fast-changing info»
  как триггер веб-поиска, а не как политическая инструкция.
